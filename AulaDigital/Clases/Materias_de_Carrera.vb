...
Public Class Materias_de_Carrera
    ...
    Sub AgregarMateriaDeCarrera(ByVal MateriaDeCarrera As Materias_de_Carrera, Optional ByVal Transact As IDbTransaction = Nothing)
        Try
            ...
            cmmd.CommandText = "INSERT INTO MATERIA_DE_CARRERA (Id_Materia, Id_Carrera, Ano_Materia) VALUES (" & MateriaDeCarrera.Id_Materia & "," & MateriaDeCarrera.Id_Carrera_de_Institucion & "," & MateriaDeCarrera.Ano_Materia & ")"
